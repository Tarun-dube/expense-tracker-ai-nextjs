  ...
  if (error) {
    return (
      <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl'>
        ...
        <div className='bg-blue-50/80 dark:bg-blue-900/20 backdrop-blur-sm p-3 sm:p-4 rounded-xl border-l-4 border-l-blue-500'>
          ...
          <p className='text-blue-700 dark:text-blue-400 text-xs ml-8'>{error}</p>
        </div>
      </div>
    );
  }
