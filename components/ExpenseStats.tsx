    ...
    return (
      <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl'>
        <div className='flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6'>
          <div className='w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg'>
        ...
        <div className='space-y-3 sm:space-y-4'>
          ...
          <div className='bg-blue-50/80 dark:bg-blue-900/20 backdrop-blur-sm rounded-xl p-3 sm:p-4 border border-blue-200/50 dark:border-blue-600/50'>
            <div className='text-center'>
              <p className='text-xs font-medium text-blue-700 dark:text-blue-300 mb-2 tracking-wide uppercase'>
                Average Daily Spending
              </p>
              <div className='text-2xl sm:text-3xl font-bold text-blue-600 dark:text-blue-300 mb-2'>
                ₹{averageExpense.toFixed(2)}
              </div>
              <div className='inline-flex items-center gap-2 bg-blue-100/50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-2 py-1 rounded-full text-xs font-medium'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3'>
            ...
            {/* Lowest Expense */}
            <div className='bg-blue-50/50 dark:bg-blue-900/10 backdrop-blur-sm p-3 sm:p-4 rounded-xl border-l-4 border-l-blue-300 hover:bg-blue-50/70 dark:hover:bg-blue-900/20'>
              <div className='flex items-center gap-2'>
                <div className='w-6 h-6 bg-blue-200 dark:bg-blue-800 rounded-xl flex items-center justify-center flex-shrink-0'>
                  <span className='text-sm leading-none text-blue-500 dark:text-blue-300 font-bold'>
                    ↓
                  </span>
                </div>
                <div className='flex-1'>
    ...
    return (
      <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl'>
        <div className='flex items-center gap-3 mb-6'>
          <div className='w-12 h-12 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg'>
            <span className='text-white text-xl'>📊</span>
          </div>
          <div>
            <h3 className='text-2xl font-bold bg-gradient-to-r from-blue-700 to-blue-400 dark:from-blue-400 dark:to-blue-300 bg-clip-text text-transparent'>
              Expense Statistics
            </h3>
        ...
        <div className='bg-blue-50/80 dark:bg-blue-900/20 backdrop-blur-sm p-6 rounded-xl border-l-4 border-l-blue-500'>
          ...
          <p className='text-blue-700 dark:text-blue-400 text-sm ml-11'>
